...
monster_types = Literal["redCamp", "blueCamp", "raptor", "wolf", "gromp", "krug", "scuttleCrab", "VoidGrub", "riftHerald", "baron", "dragon"]
epic_monster_types_parsed = Literal["VoidGrub", "riftHerald", "baron", "dragon"]
