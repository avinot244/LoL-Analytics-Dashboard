...
class Event() :
    ...
    def getEvent(self) -> Union[QueuedEpicMonsterInfoEvent, ReconnectEvent, PauseEndedEvent, QueuedDragonInfoEvent, ItemPurchasedEvent, ItemDestroyedEvent, SkillLevelUpEvent, SkillUsedEvent, SummonnerSpellUsedEvent, ChampionKillEvent, ChampionKillSpecialEvent, ChannelingStartedEvent, ItemActiveAbilityUsedEvent, WardPlacedEvent, ChannelingEndedEvent, NeutralMinionSpawnEvent, EpicMonsterKillEvent, ChampionLevelUpEvent, WardKilledEvent, EpicMonsterSpawnEvent, ItemSoldEvent, ItemUndoEvent, TurretPlateDestroyedEvent, TurretPlateGoldEarnedEvent, BuildingGoldGrantEvent, BuildingDestroyedEvent, ObjectiveBountyPrestartEvent, ObjectiveBountyFinishedEvent]:
