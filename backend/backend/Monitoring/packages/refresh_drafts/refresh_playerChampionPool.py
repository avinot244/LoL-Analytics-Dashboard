...
from Draft.models import ChampionPool

def refresh_playerChampionPool():
    ...
    for _, row in tqdm(df_player_championPool.iterrows(), total=df_player_championPool.shape[0]):
