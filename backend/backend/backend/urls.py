...
urlpatterns = [
    ...
    path('api/behavior/ADC/compute/<str:summonnerName>/<int:limit>/<str:uuid>/',ADCviews.behaviorADC_behavior_latest), # Computing latest behavior analysis given a model and a player
