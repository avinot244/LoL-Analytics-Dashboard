...
function TeamAnalysisDetailsMapOpenings({timeFrame, seriesId, gameNumber, side}) {
    ...
    const fetchPlayerMapOpenings = async (position) => {
        ...
        const result = await fetch(API_URL + `teamAnalysis/getMapOpening/`, {
            method: "PATCH",
...
export default TeamAnalysisDetailsMapOpenings