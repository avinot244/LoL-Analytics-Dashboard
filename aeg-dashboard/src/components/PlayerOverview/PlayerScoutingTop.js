...
const rows = [
    { championName: 1, winRate: 'Snow', firstName: 'Jon', age: 35 },
    { championName: 2, winRate: 'Lannister', firstName: 'Cersei', age: 42 },
    { championName: 3, winRate: 'Lannister', firstName: 'Jaime', age: 45 },
    { championName: 4, winRate: 'Stark', firstName: 'Arya', age: 16 },
    { championName: 5, winRate: 'Targaryen', firstName: 'Daenerys', age: null },
    { championName: 6, winRate: 'Melisandre', firstName: null, age: 150 },
    { championName: 7, winRate: 'Clifford', firstName: 'Ferrara', age: 44 },
    { championName: 8, winRate: 'Frances', firstName: 'Rossini', age: 36 },
    { championName: 9, winRate: 'Roxie', firstName: 'Harvey', age: 65 },
];
